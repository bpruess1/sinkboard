...
export const TIER_VALUES: Record<SizeTier, number> = {
  S: 1,
  M: 2,
  L: 4,
  XL: 8,
...
export const TIER_SINK_HOURS: Record<SizeTier, number> = {
...
export const TIER_SINK_RATE_PER_MS: Record<SizeTier, number> = {
  S: 100 / (120 * 3600 * 1000),
  M: 100 / (72 * 3600 * 1000),
  L: 100 / (48 * 3600 * 1000),
  XL: 100 / (24 * 3600 * 1000),
